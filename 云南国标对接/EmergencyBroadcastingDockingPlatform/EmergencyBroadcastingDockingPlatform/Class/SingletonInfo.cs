...
namespace EmergencyBroadcastingDockingPlatform
{
    public class SingletonInfo
    {
        ...
        public List<EBM> GlobalEBMList;//ebm消息暂存


        public bool IsCompatible;//是否为兼容模式
        public string m_UsbPwsSupport;//支持签名验签 1:支持，2：不支持
        public string SignatureType;//签名类型  1：表示软签  2：硬签  注意：此项必须在USBPSWSUPPART=1的时候生效
