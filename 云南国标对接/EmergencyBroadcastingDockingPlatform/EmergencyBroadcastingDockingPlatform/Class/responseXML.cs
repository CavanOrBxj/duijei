    ...
    public class responseXML
    {
        ...
        public XmlDocument PlatformEBMBrdLog(EBD ebdsr, List<EBM> EBMList)
        {
            ...
            foreach (EBM item in EBMList)
            {
                ...
                xmlEBMBrdItemEBMMsgBasicInfoSendTime.InnerText = "2019-04-23 15:01:23";// item.MsgBasicInfo.SendTime.ToString();
        ...
        public XmlDocument SignResponse(string refbdid, string strCertSN, string strSignatureValue)
        {
            XmlDocument xmlDoc = new XmlDocument();
            xmlDoc.AppendChild(xmlDoc.CreateXmlDeclaration("1.0", "utf-8", null));
            ...
            XmlElement xmlCertSN = xmlDoc.CreateElement("CertSN");
            //  xmlCertSN.InnerText = strCertSN;
            xmlCertSN.InnerText = "0000000000000001";
            xmlElem.AppendChild(xmlCertSN);


            //SignatureAlgorithm
            XmlElement xmlSignatureAlgorithm = xmlDoc.CreateElement("SignatureAlgorithm");
            xmlSignatureAlgorithm.InnerText = "SM2-SM3";
            xmlElem.AppendChild(xmlSignatureAlgorithm);
